<?php
/**
 * Title: Loop de álbuns do Mundo
 * Slug: loop-albuns-mundo
 * Categories: loop
 * Description: Loop de albuns do Mundo
 * Inserter: no
 */
?>

<div class="container my-5 lancamentos-home">
	<h2 class="mb-4 d-flex justify-content-between align-items-end">Últimos lançamentos no Mundo 
		<small class="fs-6 fw-normal d-inline-block w-50 text-end"><a href="<?php echo site_url(); ?>/?post_type=albuns&ordenacao=lancamentos&destaque=todos">Todos os álbuns</a></small>
	</h2>
	<div class="row gx-md-4 gx-3">
		...
		$band_posts = get_posts(array(
			...
			'tax_query'   => array(
				array(
					...
					'field'    => 'name',
					'terms'    => $country,
					'operator' => 'NOT IN', // Exclui as bandas do Brasil
				),
			),
		));
		...
		?>
			<div class="lancamento-home col-md-2 col-6 mb-3">
				<div class="album">
