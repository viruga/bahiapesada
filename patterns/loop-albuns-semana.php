<?php
/**
 * Title: Loop de Álbuns da Semana
 * Slug: loop-albuns-semana
 * Categories: loop
 * Description: Loop de albuns da Semana
 * Inserter: no
 */
?>

<div class="container my-5">
	<h2 class="mb-4 d-flex justify-content-between align-items-end">Indicações de álbuns da semana 
		<small class="fs-6 fw-normal d-inline-block w-50 text-end"><a href="<?php echo site_url(); ?>/?post_type=albuns">Mais álbuns destacados</a></small>
	</h2>
